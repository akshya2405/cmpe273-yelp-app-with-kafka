...
app.use(cors({ origin: 'http://54.219.100.35:3000', credentials: true }));

// use express session to maintain session data
app.use(session({
  secret: 'cmpe273_diners_choice',
...
app.use((req, res, next) => {
  res.setHeader('Access-Control-Allow-Origin', 'http://54.219.100.35:3000');
